...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 3 | 🌐 Go | 📅 2026-08-30 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,619 | 🐛 81 | 🌐 C | 📅 2026-08-27 for image processing.
...
* [Flask-IIIF](https://github.com/inveniosoftware/flask-iiif) ⭐ 27 | 🐛 8 | 🌐 Python | 📅 2026-07-10 - Flask extension to support IIIF in Python/Flask applications. See [Flask-IIIF previewer demo](http://flask-iiif.herokuapp.com/previewer) and [Flask-IIIF RESTful demo](http://flask-iiif.herokuapp.com/restful).
...
* [Tify](https://github.com/subugoe/tify) ⭐ 130 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-30 - Slim and fast IIIF document viewer built with Vue.js.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,024 | 🐛 76 | 🌐 Rust | 📅 2026-08-30 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
