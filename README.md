...
* [open a new issue ticket](https://github.com/IIIF/awesome-iiif/issues/new) ⭐ 561 | 🐛 14 | 📅 2026-09-17 mentioning the link or resource you want to add and some description, and the community may be able to help add it
...
* [Implementations](https://github.com/IIIF/awesome-iiif/blob/master/implementations.md) ⭐ 561 | 🐛 14 | 📅 2026-09-17
...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-09-18 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,654 | 🐛 78 | 🌐 C | 📅 2026-09-16 for image processing.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,034 | 🐛 73 | 🌐 Rust | 📅 2026-09-17 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
...
* [cozy-iiif](https://github.com/rsimon/cozy-iiif) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - A developer-friendly TypeScript API for working with IIIF resources.
...
* [Blacklight IIIF Search](https://github.com/boston-library/blacklight_iiif_search) ⭐ 15 | 🐛 6 | 🌐 Ruby | 📅 2026-03-17 - Plugin that provides IIIF Content Search functionality for [Blacklight](https://github.com/projectblacklight/blacklight) ⭐ 793 | 🐛 198 | 🌐 Ruby | 📅 2026-09-18-based Rails applications.
