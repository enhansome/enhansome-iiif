...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 3 | 🌐 Go | 📅 2026-08-26 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,606 | 🐛 80 | 🌐 C | 📅 2026-08-25 for image processing.
...
* [Tify](https://github.com/subugoe/tify) ⭐ 130 | 🐛 37 | 🌐 JavaScript | 📅 2026-08-26 - Slim and fast IIIF document viewer built with Vue.js.
