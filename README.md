...
* [SIPI](https://github.com/dasch-swiss/sipi) ⭐ 38 | 🐛 7 | 🌐 C++ | 📅 2026-09-21 - IIIFv3 image server written in C++.
...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-09-20 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,661 | 🐛 78 | 🌐 C | 📅 2026-09-19 for image processing.
...
* [React Canvas Panel](https://github.com/digirati-co-uk/react-iiif-vault?tab=readme-ov-file#canvas-panel) ⭐ 4 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-21 - A wrapper around [Atlas](https://github.com/atlas-viewer/atlas) ⭐ 6 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-21 with IIIF Image API support for image services, and Manifests.
...
* [Blacklight IIIF Search](https://github.com/boston-library/blacklight_iiif_search) ⭐ 15 | 🐛 6 | 🌐 Ruby | 📅 2026-03-17 - Plugin that provides IIIF Content Search functionality for [Blacklight](https://github.com/projectblacklight/blacklight) ⭐ 793 | 🐛 194 | 🌐 Ruby | 📅 2026-09-21-based Rails applications.
