# Awesome International Image Interoperability Framework (IIIF) with stars
...
* [open a new issue ticket](https://github.com/IIIF/awesome-iiif/issues/new) ⭐ 561 | 🐛 15 | 📅 2026-08-19 mentioning the link or resource you want to add and some description, and the community may be able to help add it
...
[Feedback is welcome](https://iiif.io/api/#feedback) on all IIIF Specifications, including draft versions and works-in-progress -- please send any feedback to <iiif-discuss@googlegroups.com>.

## Additional Lists

* [Implementations](https://github.com/IIIF/awesome-iiif/blob/master/implementations.md) ⭐ 561 | 🐛 15 | 📅 2026-08-19
...
* [go-iiif](https://github.com/thisisaaronland/go-iiif) ⭐ 98 | 🐛 51 | 🌐 Go | 📅 2026-09-09 - IIIF server written in go (fork of [greut/iiif](https://github.com/greut/iiif) ⭐ 11 | 🐛 3 | 🌐 Go | 📅 2021-02-15).
...
* [SIPI](https://github.com/dasch-swiss/sipi) ⭐ 38 | 🐛 6 | 🌐 C++ | 📅 2026-09-17 - IIIFv3 image server written in C++.
...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,653 | 🐛 78 | 🌐 C | 📅 2026-09-16 for image processing.
...
* [Flask-IIIF](https://github.com/inveniosoftware/flask-iiif) ⭐ 27 | 🐛 9 | 🌐 Python | 📅 2026-07-10 - Flask extension to support IIIF in Python/Flask applications. See [Flask-IIIF previewer demo](http://flask-iiif.herokuapp.com/previewer) and [Flask-IIIF RESTful demo](http://flask-iiif.herokuapp.com/restful).
* [Djatoka Ruby gem](https://github.com/jronallo/djatoka) ⭐ 20 | 🐛 0 | 🌐 Ruby | 📅 2015-11-04 - Convert IIIF URLs into the URLs that Djatoka requires.
* [Shimmy](https://github.com/mejackreed/shimmy) ⭐ 14 | 🐛 0 | 🌐 Ruby | 📅 2016-03-21 - Ruby gem designed to help you build shims for the IIIF Presentation API.
* [djiiif](https://github.com/rogerhoward/djiiif) ⚠️ Archived - Package designed to make integrating the IIIF Image API easier by extending Django's ImageField.
* [ContentDM Image translator](https://github.com/azaroth42/pi3f/tree/master/shims/ContentDM) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2016-10-27 - Makes ContentDM images available through IIIF. Python.

## IIIF Viewers

* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,176 | 🐛 292 | 🌐 JavaScript | 📅 2026-09-15 - A viewer developed by the Internet Archive, specially suited for viewing books.
* [Tify](https://github.com/subugoe/tify) ⭐ 130 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-16 - Slim and fast IIIF document viewer built with Vue.js.
...
* [Imaging Helper Plugin](https://github.com/msalsbery/OpenSeadragonImagingHelper) ⭐ 18 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14 - OpenSeadragon plugin with utility functions.
* [React Canvas Panel](https://github.com/digirati-co-uk/react-iiif-vault?tab=readme-ov-file#canvas-panel) ⭐ 4 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-14 - A wrapper around [Atlas](https://github.com/atlas-viewer/atlas) ⭐ 6 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-16 with IIIF Image API support for image services, and Manifests.
* [OpenSeadragon](https://openseadragon.github.io/examples/tilesource-iiif/) - IIIF tile support.
  * [Curtain Viewer](https://github.com/vanda/curtain-viewer) ⭐ 13 | 🐛 9 | 🌐 JavaScript | 📅 2024-09-02 - Viewer based on OpenSeadragon using the curtain-sync plugin for comparing naturally aligned image variants
...
* [Node node-iiif](https://github.com/samvera/node-iiif) ⭐ 33 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-11 - a full-featured image processor supporting the IIIF Image API versions 2.1 and 3.0.
* [iiif-apis](https://github.com/dbmdz/iiif-apis) ⭐ 30 | 🐛 11 | 🌐 Java | 📅 2026-09-16 - Java IIIF API libraries.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,034 | 🐛 73 | 🌐 Rust | 📅 2026-09-14 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
...
* [Manifesto](https://github.com/UniversalViewer/manifesto) ⭐ 50 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-13 - IIIF Presentation API client and server utility library.
* [iiif-prezi3](https://github.com/iiif-prezi/iiif-prezi3) ⭐ 42 | 🐛 38 | 🌐 Python | 📅 2026-08-03 - Presentation 3 Python library.
...
* [IIIF Parser](https://github.com/iiif-commons/parser) ⭐ 19 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-15 - An NPM module (Node + Browser) for parsing IIIF Presentation 2.1, 3.0, 4.0 and upgrading from v2 to v3. [demo](https://iiif-studio.netlify.app/)
...
* [jiiify-presentation](https://github.com/ksclarke/jiiify-presentation) ⭐ 11 | 🐛 3 | 📅 2026-09-11 - A Java IIIF Presentation library.
* [Manifold](https://github.com/UniversalViewer/manifold) ⭐ 7 | 🐛 10 | 🌐 TypeScript | 📅 2026-04-23 - Wraps Manifesto to provide viewer state and related utilities.
...
* [IIIF Helpers](https://github.com/IIIF-Commons/iiif-helpers) ⭐ 5 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-10 - An NPM module with a variety of helpers for working with IIIF Presentation resources.
...
* [Shimmy](https://github.com/mejackreed/shimmy) ⭐ 14 | 🐛 0 | 🌐 Ruby | 📅 2016-03-21 - Ruby gem designed to help you build shims for the IIIF Presentation API, and has samples for NYPL, Flickr, and the US National Archives.
* [Chronicling America](https://github.com/azaroth42/presentation-api-shims/tree/master/shims/chronam) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2016-10-27 - For newspapers digitized in the National Digital Newspaper Program.
...
* [Leiden's Islandora IIIF Manifest Generator](https://github.com/LeidenUniversityLibrary/islandora_iiif_manifests) ⭐ 0 | 🐛 1 | 🌐 PHP | 📅 2026-08-28 - A module to generate IIIF Manifest for Islandora.
...
* [Blacklight IIIF Search](https://github.com/boston-library/blacklight_iiif_search) ⭐ 15 | 🐛 6 | 🌐 Ruby | 📅 2026-03-17 - Plugin that provides IIIF Content Search functionality for [Blacklight](https://github.com/projectblacklight/blacklight) ⭐ 793 | 🐛 196 | 🌐 Ruby | 📅 2026-09-11-based Rails applications.
...
* [iiif-image-auth](https://github.com/robcast/iiif-image-auth) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2019-07-15 - (IIIF Auth 1.0) A simple server implementation based on Docker and Flask.
* [iiif-auth-client](https://github.com/tomcrane/iiif-auth-client) ⭐ 1 | 🐛 1 | 🌐 JavaScript | 📅 2024-03-26 - Client implementation of the IIIF Authorization Flow specification.
* [iiif-auth-server](https://github.com/tomcrane/iiif-auth-server) ⭐ 0 | 🐛 1 | 🌐 Python | 📅 2024-03-12 - A demo server implementation of all aspects of the IIIF Authorization Flow specification.
...
* [Experiments with IIIF and Gallica](https://github.com/altomator/IIIF/) ⭐ 33 | 🐛 0 | 🌐 JavaScript | 📅 2025-11-16 - A guided tour of end user applications of IIIF to Gallica materials, by Jean-Philippe Moreux (BnF).
* [IIIF Workshop for DHNord2020](https://github.com/regisrob/Atelier_IIIF_Conference_DHNord_2020) ⭐ 7 | 🐛 0 | 📅 2020-11-18 - French langauge workshop with three exercises from a workshop entitled "Adopt and use IIIF standards for your digital image corpora," created by Régis Robineau (technical coordinator of Biblissima) and Johann Holland (TGIR Huma-Num).
* [IIIF Online Workshop](https://training.iiif.io/iiif-online-workshop/) - IIIF workshop materials and videos given by the IIIF-C and updated at each occurrence.
...
* [iiif-universe](https://github.com/ryanfb/iiif-universe) ⭐ 27 | 🐛 5 | 🌐 Ruby | 📅 2026-05-08 - Repository that includes links to known IIIF presentation manifest collections.
* [iNQUIRE source](https://github.com/armadillo-systems/inquire) ⭐ 11 | 🐛 5 | 🌐 JavaScript | 📅 2023-03-03 - Github repository for iNQUIRE.
...
* [IMMARKUS](https://github.com/rsimon/immarkus) ⭐ 64 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-14 - A semantic image annotation tool for researchers, digital humanists and cultural heritage professionals.
...
* [SimpleAnnotationServer](https://github.com/glenrobson/SimpleAnnotationServer) ⭐ 104 | 🐛 25 | 🌐 JavaScript | 📅 2026-03-01 - Java annotation server backed by an Apache Jena triple store, Sesame, or Solr.
* [Elucidate](https://github.com/dlcs/elucidate-server) ⭐ 55 | 🐛 24 | 🌐 Java | 📅 2022-01-04 - Java and Postgres annotation server.
...
* [Mirador Annotation Editor](https://github.com/TETRAS-IIIF/mirador-annotation-editor) ⭐ 11 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-31 : Mirador 4 plugin that adds annotation editing capabilities to Mirador. Embedded in [Mirador Multi User](https://www.mirador-multi-user.com/).
* [Adno](https://adno.app/en/) - a web application for viewing, editing and sharing narratives and pathways on IIIF images.
...
* [IIIF Toolkit](https://github.com/utlib/IiifItems) ⭐ 18 | 🐛 3 | 🌐 JavaScript | 📅 2024-11-08 - IIIF Toolkit by University of Toronto Libraries is a plugin for Omeka Classic (2.3+) that integrates Mirador with a built-in annotator, a manifest generator, Simple Pages shortcodes and Exhibit Builder blocks for a rich presentation experience.
* [Mirador Viewer Omeka S Module](https://github.com/Daniel-KM/Omeka-S-module-Mirador) ⭐ 9 | 🐛 3 | 🌐 PHP | 📅 2026-05-23 - Omeka S module that integrates the Mirador image viewer.
...
* [Mirador extension to MediaWiki](https://github.com/a-g-van-hamel-foundation/Mirador) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-23 - MediaWiki extension which offers the Mirador Viewer along with a number of open-source plugins.

## Hosting

Internet file hosting that provides IIIF support (including both paid and free options).

* [tiny.iiif](https://github.com/rsimon/tiny-iiif/) ⭐ 64 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-24 - An open-source IIIF server for self-hosting
...
* [Populating the Annotation Store with IIIF Annotation List](https://github.com/glenrobson/SimpleAnnotationServer/blob/master/doc/PopulatingAnnotations.md) ⭐ 104 | 🐛 25 | 🌐 JavaScript | 📅 2026-03-01 - Provides instructions on how to edit OCR text using annotations in Mirador.
* [Open ONI (Open Online Newspaper Initiative)](https://github.com/open-oni/open-oni) ⭐ 56 | 🐛 88 | 🌐 Python | 📅 2026-09-15 - Open Online Newspaper Initiative (Open ONI) is a community-maintained project to make historic American newspapers browsable and searchable on the web.
* [ndnp\_iiif](https://github.com/umd-mith/ndnp_iiif) ⭐ 12 | 🐛 5 | 🌐 JavaScript | 📅 2016-06-07 - Python program for turning [National Digital Newspaper Program data](https://www.loc.gov/ndnp/) into static IIIF JSON that is ready for mounting on the Web.
...
* [iiif\_io on Twitter](https://twitter.com/iiif_io).
...
* [Muzai.io platform](https://muzai.io) (based on [Brif](https://github.com/pierrz/brif) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2026-05-27)
* [Invenio](https://invenio-software.org/products/framework/) (Image API implementation via [invenio-iiif](https://github.com/inveniosoftware/invenio-iiif) ⭐ 5 | 🐛 6 | 🌐 Python | 📅 2026-06-11)
