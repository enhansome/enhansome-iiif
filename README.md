...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-09-20 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,672 | 🐛 82 | 🌐 C | 📅 2026-09-23 for image processing.
...
* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,179 | 🐛 294 | 🌐 JavaScript | 📅 2026-09-23 - A viewer developed by the Internet Archive, specially suited for viewing books.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,036 | 🐛 75 | 🌐 Rust | 📅 2026-09-17 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
...
* [iiif-prezi3](https://github.com/iiif-prezi/iiif-prezi3) ⭐ 42 | 🐛 34 | 🌐 Python | 📅 2026-09-23 - Presentation 3 Python library.
...
* [jiiify-presentation](https://github.com/ksclarke/jiiify-presentation) ⭐ 12 | 🐛 3 | 📅 2026-09-11 - A Java IIIF Presentation library.
...
* [Blacklight IIIF Search](https://github.com/boston-library/blacklight_iiif_search) ⭐ 15 | 🐛 6 | 🌐 Ruby | 📅 2026-03-17 - Plugin that provides IIIF Content Search functionality for [Blacklight](https://github.com/projectblacklight/blacklight) ⭐ 793 | 🐛 195 | 🌐 Ruby | 📅 2026-09-23-based Rails applications.
