...
* [Implementations](https://github.com/IIIF/awesome-iiif/blob/master/implementations.md) ⭐ 560 | 🐛 14 | 📅 2026-08-19
...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 3 | 🌐 Go | 📅 2026-08-29 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,614 | 🐛 81 | 🌐 C | 📅 2026-08-27 for image processing.
...
* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,175 | 🐛 288 | 🌐 JavaScript | 📅 2026-08-18 - A viewer developed by the Internet Archive, specially suited for viewing books.
* [Tify](https://github.com/subugoe/tify) ⭐ 130 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-28 - Slim and fast IIIF document viewer built with Vue.js.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,023 | 🐛 75 | 🌐 Rust | 📅 2026-08-28 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
