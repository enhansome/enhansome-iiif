...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-09-13 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,635 | 🐛 80 | 🌐 C | 📅 2026-09-13 for image processing.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,030 | 🐛 74 | 🌐 Rust | 📅 2026-09-04 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
