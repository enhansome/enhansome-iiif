...
* [open a new issue ticket](https://github.com/IIIF/awesome-iiif/issues/new) ⭐ 560 | 🐛 15 | 📅 2026-08-03 mentioning the link or resource you want to add and some description, and the community may be able to help add it
...
* [Implementations](https://github.com/IIIF/awesome-iiif/blob/master/implementations.md) ⭐ 560 | 🐛 15 | 📅 2026-08-03
...
* [SIPI](https://github.com/dasch-swiss/sipi) ⭐ 38 | 🐛 18 | 🌐 C++ | 📅 2026-08-18 - IIIFv3 image server written in C++.
...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-08-18 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,579 | 🐛 82 | 🌐 C | 📅 2026-08-18 for image processing.
...
* [Tify](https://github.com/subugoe/tify) ⭐ 129 | 🐛 30 | 🌐 JavaScript | 📅 2026-08-12 - Slim and fast IIIF document viewer built with Vue.js.
...
* [React Canvas Panel](https://github.com/digirati-co-uk/react-iiif-vault?tab=readme-ov-file#canvas-panel) ⭐ 4 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-14 - A wrapper around [Atlas](https://github.com/atlas-viewer/atlas) ⭐ 6 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-13 with IIIF Image API support for image services, and Manifests.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,024 | 🐛 84 | 🌐 Rust | 📅 2026-08-13 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
...
* [tropiiify](https://github.com/martimpassos/tropiiify) ⭐ 29 | 🐛 7 | 🌐 JavaScript | 📅 2025-08-27 Tropy plugin that exports images, metadata and annotations as a (level0) IIIF collection.
...
* [Exhibition Editor](https://manifest-editor-docs.netlify.app/docs/exhibition-building) - an extension to the [Digirati Manifest Editor](https://github.com/digirati-co-uk/iiif-manifest-editor) ⭐ 45 | 🐛 63 | 🌐 TypeScript | 📅 2026-08-14 which supports the creation and development of IIIF content for storytelling or exhibition style presentations.
...
* [Blacklight IIIF Search](https://github.com/boston-library/blacklight_iiif_search) ⭐ 14 | 🐛 6 | 🌐 Ruby | 📅 2026-03-17 - Plugin that provides IIIF Content Search functionality for [Blacklight](https://github.com/projectblacklight/blacklight) ⭐ 792 | 🐛 194 | 🌐 Ruby | 📅 2026-08-10-based Rails applications.
...
* [Open ONI (Open Online Newspaper Initiative)](https://github.com/open-oni/open-oni) ⭐ 55 | 🐛 88 | 🌐 Python | 📅 2026-07-10 - Open Online Newspaper Initiative (Open ONI) is a community-maintained project to make historic American newspapers browsable and searchable on the web.
