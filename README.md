...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-09-20 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,669 | 🐛 81 | 🌐 C | 📅 2026-09-21 for image processing.
...
* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,179 | 🐛 293 | 🌐 JavaScript | 📅 2026-09-23 - A viewer developed by the Internet Archive, specially suited for viewing books.
