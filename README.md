...
* [SIPI](https://github.com/dasch-swiss/sipi) ⭐ 38 | 🐛 5 | 🌐 C++ | 📅 2026-08-31 - IIIFv3 image server written in C++.
...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 3 | 🌐 Go | 📅 2026-08-31 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,622 | 🐛 81 | 🌐 C | 📅 2026-08-31 for image processing.
...
* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,176 | 🐛 288 | 🌐 JavaScript | 📅 2026-08-18 - A viewer developed by the Internet Archive, specially suited for viewing books.
* [Tify](https://github.com/subugoe/tify) ⭐ 130 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-31 - Slim and fast IIIF document viewer built with Vue.js.
...
* [Mirador Video](https://github.com/TETRAS-IIIF/mirador-video) ⭐ 5 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-20 - Mirador 4 fork supporting annotation on videos.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,026 | 🐛 76 | 🌐 Rust | 📅 2026-08-31 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
...
* [IIIF Downloader](https://github.com/ClaudioMartino/IIIF-Downloader) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-08-19 - Lightweight Python image downloader that needs only standard libraries (CLI + API + GUI). Compliant with IIIF API 2.0, 2.1 and 3.0.
...
* [Blacklight IIIF Search](https://github.com/boston-library/blacklight_iiif_search) ⭐ 14 | 🐛 6 | 🌐 Ruby | 📅 2026-03-17 - Plugin that provides IIIF Content Search functionality for [Blacklight](https://github.com/projectblacklight/blacklight) ⭐ 792 | 🐛 196 | 🌐 Ruby | 📅 2026-08-31-based Rails applications.
...
* [IMMARKUS](https://github.com/rsimon/immarkus) ⭐ 63 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-11 - A semantic image annotation tool for researchers, digital humanists and cultural heritage professionals.
...
* [Mirador Annotation Editor](https://github.com/TETRAS-IIIF/mirador-annotation-editor) ⭐ 11 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-20 : Mirador 4 plugin that adds annotation editing capabilities to Mirador. Embedded in [Mirador Multi User](https://www.mirador-multi-user.com/).
* [Adno](https://adno.app/en/) - a web application for viewing, editing and sharing narratives and pathways on IIIF images.
