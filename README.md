...
* [open a new issue ticket](https://github.com/IIIF/awesome-iiif/issues/new) ⭐ 561 | 🐛 14 | 📅 2026-08-19 mentioning the link or resource you want to add and some description, and the community may be able to help add it
...
* [Implementations](https://github.com/IIIF/awesome-iiif/blob/master/implementations.md) ⭐ 561 | 🐛 14 | 📅 2026-08-19
...
* [SIPI](https://github.com/dasch-swiss/sipi) ⭐ 38 | 🐛 6 | 🌐 C++ | 📅 2026-09-13 - IIIFv3 image server written in C++.
...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,649 | 🐛 78 | 🌐 C | 📅 2026-09-16 for image processing.
...
* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,175 | 🐛 292 | 🌐 JavaScript | 📅 2026-09-15 - A viewer developed by the Internet Archive, specially suited for viewing books.
* [Tify](https://github.com/subugoe/tify) ⭐ 130 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-13 - Slim and fast IIIF document viewer built with Vue.js.
...
* [iiif-apis](https://github.com/dbmdz/iiif-apis) ⭐ 30 | 🐛 11 | 🌐 Java | 📅 2026-09-15 - Java IIIF API libraries.
...
* [Blacklight IIIF Search](https://github.com/boston-library/blacklight_iiif_search) ⭐ 15 | 🐛 6 | 🌐 Ruby | 📅 2026-03-17 - Plugin that provides IIIF Content Search functionality for [Blacklight](https://github.com/projectblacklight/blacklight) ⭐ 793 | 🐛 197 | 🌐 Ruby | 📅 2026-09-11-based Rails applications.
