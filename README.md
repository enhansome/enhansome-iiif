...
* [SIPI](https://github.com/dasch-swiss/sipi) ⭐ 38 | 🐛 7 | 🌐 C++ | 📅 2026-09-25 - IIIFv3 image server written in C++.
...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 5 | 🌐 Go | 📅 2026-09-20 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,676 | 🐛 78 | 🌐 C | 📅 2026-09-26 for image processing.
...
* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,178 | 🐛 294 | 🌐 JavaScript | 📅 2026-09-24 - A viewer developed by the Internet Archive, specially suited for viewing books.
...
* [React Canvas Panel](https://github.com/digirati-co-uk/react-iiif-vault?tab=readme-ov-file#canvas-panel) ⭐ 4 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-22 - A wrapper around [Atlas](https://github.com/atlas-viewer/atlas) ⭐ 6 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-25 with IIIF Image API support for image services, and Manifests.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,037 | 🐛 75 | 🌐 Rust | 📅 2026-09-17 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
...
* [cozy-iiif](https://github.com/rsimon/cozy-iiif) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - A developer-friendly TypeScript API for working with IIIF resources.
...
* [Blacklight IIIF Search](https://github.com/boston-library/blacklight_iiif_search) ⭐ 15 | 🐛 6 | 🌐 Ruby | 📅 2026-03-17 - Plugin that provides IIIF Content Search functionality for [Blacklight](https://github.com/projectblacklight/blacklight) ⭐ 794 | 🐛 194 | 🌐 Ruby | 📅 2026-09-23-based Rails applications.
...
* [IMMARKUS](https://github.com/rsimon/immarkus) ⭐ 65 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-25 - A semantic image annotation tool for researchers, digital humanists and cultural heritage professionals.
