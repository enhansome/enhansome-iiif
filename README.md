...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 3 | 🌐 Go | 📅 2026-08-31 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,621 | 🐛 81 | 🌐 C | 📅 2026-08-31 for image processing.
...
* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,176 | 🐛 290 | 🌐 JavaScript | 📅 2026-09-01 - A viewer developed by the Internet Archive, specially suited for viewing books.
* [Tify](https://github.com/subugoe/tify) ⭐ 130 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-31 - Slim and fast IIIF document viewer built with Vue.js.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,027 | 🐛 79 | 🌐 Rust | 📅 2026-09-01 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
