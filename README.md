...
* [SIPI](https://github.com/dasch-swiss/sipi) ⭐ 38 | 🐛 6 | 🌐 C++ | 📅 2026-09-22 - IIIFv3 image server written in C++.
...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-09-20 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,665 | 🐛 78 | 🌐 C | 📅 2026-09-21 for image processing.
...
* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,178 | 🐛 293 | 🌐 JavaScript | 📅 2026-09-15 - A viewer developed by the Internet Archive, specially suited for viewing books.
...
* [React Canvas Panel](https://github.com/digirati-co-uk/react-iiif-vault?tab=readme-ov-file#canvas-panel) ⭐ 4 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-22 - A wrapper around [Atlas](https://github.com/atlas-viewer/atlas) ⭐ 6 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-22 with IIIF Image API support for image services, and Manifests.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,035 | 🐛 74 | 🌐 Rust | 📅 2026-09-17 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
...
* [cozy-iiif](https://github.com/rsimon/cozy-iiif) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - A developer-friendly TypeScript API for working with IIIF resources.
...
* [Exhibition Editor](https://manifest-editor-docs.netlify.app/docs/exhibition-building) - an extension to the [Digirati Manifest Editor](https://github.com/digirati-co-uk/iiif-manifest-editor) ⭐ 45 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-22 which supports the creation and development of IIIF content for storytelling or exhibition style presentations.
...
* [Blacklight IIIF Search](https://github.com/boston-library/blacklight_iiif_search) ⭐ 15 | 🐛 6 | 🌐 Ruby | 📅 2026-03-17 - Plugin that provides IIIF Content Search functionality for [Blacklight](https://github.com/projectblacklight/blacklight) ⭐ 793 | 🐛 194 | 🌐 Ruby | 📅 2026-09-22-based Rails applications.
...
* [IMMARKUS](https://github.com/rsimon/immarkus) ⭐ 65 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-14 - A semantic image annotation tool for researchers, digital humanists and cultural heritage professionals.
