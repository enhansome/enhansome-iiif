...
* [triplet](https://github.com/libops/triplet) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-09-14 - A fast IIIF Image API 3.0 and Presentation API 3.0 server written in Go, powered by [libvips](https://github.com/libvips/libvips) ⭐ 11,639 | 🐛 79 | 🌐 C | 📅 2026-09-14 for image processing.
...
* [Internet Archive BookReader](https://github.com/internetarchive/bookreader) ⭐ 1,174 | 🐛 290 | 🌐 JavaScript | 📅 2026-09-10 - A viewer developed by the Internet Archive, specially suited for viewing books.
* [Tify](https://github.com/subugoe/tify) ⭐ 130 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-13 - Slim and fast IIIF document viewer built with Vue.js.
...
* [Imaging Helper Plugin](https://github.com/msalsbery/OpenSeadragonImagingHelper) ⭐ 18 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-13 - OpenSeadragon plugin with utility functions.
* [React Canvas Panel](https://github.com/digirati-co-uk/react-iiif-vault?tab=readme-ov-file#canvas-panel) ⭐ 4 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-14 - A wrapper around [Atlas](https://github.com/atlas-viewer/atlas) ⭐ 6 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-09 with IIIF Image API support for image services, and Manifests.
...
* [iiif-apis](https://github.com/dbmdz/iiif-apis) ⭐ 30 | 🐛 11 | 🌐 Java | 📅 2026-09-04 - Java IIIF API libraries.
...
* [dezoomify-rs](https://github.com/lovasoa/dezoomify-rs) ⭐ 1,032 | 🐛 74 | 🌐 Rust | 📅 2026-09-04 - A command-line tiled image downloader. Support IIIF, Deepzoom and others zoomable image formats.
...
* [Manifesto](https://github.com/UniversalViewer/manifesto) ⭐ 50 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-13 - IIIF Presentation API client and server utility library.
...
* [IIIF Parser](https://github.com/iiif-commons/parser) ⭐ 19 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-26 - An NPM module (Node + Browser) for parsing IIIF Presentation 2.1, 3.0, 4.0 and upgrading from v2 to v3. [demo](https://iiif-studio.netlify.app/)
...
* [Open ONI (Open Online Newspaper Initiative)](https://github.com/open-oni/open-oni) ⭐ 56 | 🐛 88 | 🌐 Python | 📅 2026-07-10 - Open Online Newspaper Initiative (Open ONI) is a community-maintained project to make historic American newspapers browsable and searchable on the web.
